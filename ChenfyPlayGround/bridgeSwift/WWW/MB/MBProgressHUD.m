...
//			CGSize labelSize = [detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize:CGSizeMake(frame.size.width - 4*margin, maxHeight) lineBreakMode:detailsLabel.lineBreakMode];
            ...
            NSAttributedString *str = [[NSAttributedString alloc]initWithString:detailsLabel.text];
            NSStringDrawingOptions options =  NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading;
            CGRect rect = [str boundingRectWithSize:CGSizeMake(frame.size.width - 4*margin, maxHeight) options:options context:nil];
